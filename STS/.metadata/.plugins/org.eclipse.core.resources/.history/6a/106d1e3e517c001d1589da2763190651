...
<body>
	...
	<form action="<%=request.getContextPath()%>/EnqAgent"
		method="post">
		<%--  --%>
								...
								<div class="input-group" style="width: 80px;">
									...
									<div style="position: relative;">
										<input name="branch" id="branch" type="text" size="10"
											style="overflow: hidden; white-space: nowrap; position: relative; top: 0; left: 0; text-align: left; background-color: rgb(238, 238, 238); color: rgb(153, 153, 153); font-weight: bold; width: 80px;"
									...
									<tbody>
										<tr>
											...
											<td style="width: 100px;"><input name="agntname"
												...
												style="margin-left: 1px; overflow: hidden; white-space: nowrap; position: relative; top: 0; left: 0; text-align: left; background-color: rgb(238, 238, 238); color: rgb(153, 153, 153); font-weight: bold; width: 80px;"
							...
							<div class="form-group" style="width: 110px;">
								...
								<div style="position: relative;">
									<select name="dbtype" id="dbtype" value="" type="list"
										style="width: 195.0px; margin-right: -3px; background-color: rgb(238, 238, 238); color: rgb(153, 153, 153); font-weight: bold; width: 80px;"
							...
							<div class="form-group" style="width: 110px;">
								...
								<div style="position: relative;">
									<select name="dbstatus" id="dbstatus" value="" type="list"
										style="width: 195.0px; background-color: rgb(238, 238, 238); color: rgb(153, 153, 153); font-weight: bold; " onfocus="doFocus(this)"
										onhelp="return fieldHelp" class="form-control" tabindex="7"><option
							...
							<div class="form-group language">
								...
								<div class="input-group" style="min-width: 130px;">
									<input name="License" id="License" type="text" size="15"
										style="overflow: hidden; white-space: nowrap; position: relative; top: 0; left: 0; text-align: left; background-color: rgb(238, 238, 238); color: rgb(153, 153, 153); font-weight: bold; width: 80px;"
										value="<%=LicenseNumber%>" maxlength="15" class="form-control" tabindex="11" disabled>
								</div>
