								...
								<table>
									<tbody>
										<tr>
											<td>
												<%
													String cownsel01 = (String) session.getAttribute("cownsel01");
													String statdets = (String) session.getAttribute("statdets");
													String InceptionDate = (String) session.getAttribute("InceptionDate");
													String ExpiryDate = (String) session.getAttribute("ExpiryDate");
													String PolicyOwner = (String) session.getAttribute("PolicyOwner");
													String EngineNo = (String) session.getAttribute("EngineNo");
													String ChassisNo = (String) session.getAttribute("ChassisNo");
													String VehicleRegisNo = (String) session.getAttribute("VehicleRegisNo");
													String BillingCurrency = (String) session.getAttribute("BillingCurrency");
													String SumInsured = (String) session.getAttribute("SumInsured");
													String Rate = (String) session.getAttribute("Rate");
													String AnnualPremium = (String) session.getAttribute("AnnualPremium");
													String PostedPremium = (String) session.getAttribute("PostedPremium");
													
													String tittle = null;
													if (statdets.contains("IF")) {
														tittle = "In Force";
														}else {
															tittle = "Pending New Business";
														}
												...
												<div title="36022773" 
													...
													class="form-control ellipsis"><%=cownsel01%></div>
													</div>
											</td>
											...
											<td style="padding-left: 1px;">
												...
												<div title="Group Endowment               "
													...
													id="ctypdesc_div" name="ctypdesc_div" value=""
													class="form-control ellipsis">Moto Policy</div>
										...
										<tr>
											<td>
												<div title="PN"
													...
													class="form-control ellipsis"><%=statdets%></div>
											</td>
											<td>
												<div
							...
							<div class="form-group">
								...
								<div class="input-group" style="min-width: 100px">
									...
									<div
										...
										class="form-control ellipsis" value="<%=InceptionDate%>"><%=InceptionDate%></div>
								</div>
										...
										<td class="form-group">
											...
											<div class="input-group" style="width: 150px;">
												<input name="ownersel" id="ownersel" type="text" size="10"
													...
													value="" maxlength="10" placeholder="<%=PolicyOwner%>"
											...
											<td>
												...
												<div>
													<div title="01/03/2022"
														...
														onhelp="return fieldHelp(&quot;occdateDisp&quot;)"><%=InceptionDate%></div>
												</div>
							...
							<div class="form-group">
								...
								<div class="input-group date form_date col-md-12"
									...
									<input name="btdateDisp" id="btdateDisp" type="text" size="10"
										...
										value="" maxlength="10" placeholder="<%=ExpiryDate%>"   
							...
							<div class="form-group">
								...
								<div class="input-group date form_date col-md-12"
									...
									<input name="insuredTo" id="insuredTo" type="text" size="10"
										style="overflow: hidden; white-space: nowrap; position: relative; top: 0; left: 0; text-align: left;"
										value="" maxlength="10" class="input_cell bold form-control" placeholder="<%=ExpiryDate%>">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input name="EngineNo" id="EngineNo" type="text" size="3"
										...
										value="" maxlength="9" decimal="0" placeholder="<%=EngineNo%>"
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input name="ChassisNo" id="ChassisNo" type="text" size="3"
										style="position: relative; top: 0; left: 0; text-align: right;"
										value="" maxlength="9" decimal="0" placeholder="<%=ChassisNo%>"
										class="input_cell bold form-control">
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input name="RegistrationNo" id="RegistrationNo" type="text"
										...
										class="input_cell bold form-control" placeholder="<%=VehicleRegisNo%>">
								</div>
							</div>
						</div>
					</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<select id="cntcurr" name="cntcurr" type="list"
										...
										<option value="" title="---------Select---------" selected=""><%=BillingCurrency%></option>
					...
					<div class="row">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input name="SumInsured" id="SumInsured" type="text" size="20"
										...
										value="" maxlength="47" onfocus="doFocus(this)" placeholder="<%=SumInsured%>
										class="form-control">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input name="btnAnnualPremium" id="btnAnnualPremium" type="text"
										size="20"
										style="width: 100px; margin-left: 0px; overflow: hidden; white-space: nowrap; position: relative; top: 0; left: 0; text-align: left;"
										value="" maxlength="47" class="form-control"  placeholder="<%=AnnualPremium%>">
					...
					<div class="row">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input name="Rate" id="Rate" type="text" size="20"
										style="width: 100px; margin-left: 0px; overflow: hidden; white-space: nowrap; position: relative; top: 0; left: 0; text-align: left;"
										value="" maxlength="47" class="form-control" placeholder="<%=Rate%>">
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input name="btnPostedPremium" id="btnPostedPremium" type="text"
										size="20"
										style="width: 100px; margin-left: 0px; overflow: hidden; white-space: nowrap; position: relative; top: 0; left: 0; text-align: left;"
										value="" maxlength="47" class="form-control" placeholder="<%=PostedPremium%>">
				...
				<div id="navigateButton" class="text-right"
					...
					<script>
						...
						function refreshPage() {
							...
							document.getElementById('btnAnnualPremium').value = AnnualPremium;
							document.getElementById('btnPostedPremium').value = PostedPremium;
						}
					</script>
