...
<body>
	...
	<!-- End nvo32 -->
	<h1 style="margin-left: 20px;">New Business - Sub Menu</h1>
	<form action="<%=request.getContextPath()%>/agents" method="post">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								<label>
									<div class="label_txt" style="position: relative; bottom: 3px;">Policy
										Number</div>
								</label>
								<div class="input-group" style="max-width: 120px">
									<input name="cownsel01" id="cownsel01" type="text" size="10"
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<div style="position: relative;">
										<select name="gpoltyp" id="gpoltyp" value="" type="list"
											style="width: 250.0px;" class="codedescdropdown form-control"
											tabindex="4"><option value=""
												title="---------Select---------">---------Select---------</option>
											<option value="PolicyMotor" title="Affinity Group">Policy
												Motor</option>
										</select>
									</div>
									<!-- IGroup-937 End -->
						...
						<div class="col-md-3">
							<div class="form-group">
								<label>
									<div class="label_txt" style="position: relative; bottom: 3px;">Effective
										Date</div>
								</label>
								<div class="input-group date form_date col-md-10"
									data-date="12/11/2022" data-link-field="effdateDisp">
									<input name="effdateDisp" id="effdateDisp" type="text"
										size="10"
										...
										class="input_cell bold form-control" tabindex="5"> <span
		...
		<div class="panel panel-default secondPanel" style="height: auto;">
			<div class="panel-heading">
				<img
					src="/csc-group-asia-web/screenFiles/eng/menu/Action_icon02.png"
					height="25" title="Actions">Action
			</div>
					...
					<div class="col-md-3">
						...
						<label class="radio-inline">
							<div
								...
								<input type="radio" name="action" id="label_action_A" value="A" checked=""
									style="height: 17px; vertical-align: bottom;" tabindex="16"><label
									for="label_action_A"
									style="font-weight: bold; height: 100% !important; height: 90%;">Work
									With Policy</label>
							</div>
						</label>
				...
				<div class="row row-subMenu">
					<div class="col-md-3">
						<label class="radio-inline"><div
								style="position: relative; top: 2px; left: 0px; height: 17px;">
								<input type="radio" name="action" id="label_action_F" value="F"
									style="height: 17px; vertical-align: bottom;" tabindex="21"><label
									for="label_action_F"
									style="font-weight: bold; height: 100% !important; height: 90%;">Issue
									Policy</label>
							</div> </label>
					</div>
					...
					<div class="col-md-3">
						<label class="radio-inline">
							<div
								style="position: relative; top: 2px; left: 0px; height: 17px;">
								<input type="radio" name="action" id="label_action_H" value="H"
									style="height: 17px; vertical-align: bottom;" tabindex="23"><label
									for="label_action_H"
									style="font-weight: bold; height: 100% !important; height: 90%;">Modify
									Policy</label>
							</div>
						</label>
		...
		<div id="navigateButton" class="text-right"
			...
			<button id="exitbutton" style="margin-right: 2px !important;"
				type="button" class="btn btn-danger btn-sm">Exit</button>
			<button id="refreshbutton" type="button" class="btn btn-sm"
				style="color: #fff;; background-color: #5bc0de; border-color: #46b8da; margin-right: 2px !important;">Refresh</button>
