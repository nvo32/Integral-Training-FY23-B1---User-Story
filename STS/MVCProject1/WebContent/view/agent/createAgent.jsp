...
<body>
	...
	<form action="<%=request.getContextPath()%>/createAgents" method="post">
		<!-- menu1 -->
								...
								<div class="form-group">
									...
									<div style="display: table; width: 110px;">
										<div class="input-group" style="width: 70px;">
											<input name="clntnum" id="clntnum" type="text" size="8" style="padding-top: 3px; overflow: hidden; white-space: nowrap; position: relative; top: 0px; left: 0px; text-align: left; min-width: 70px;" maxlength="8" >
										</div>
		...
		<div class="panel panel-default secondPanel" style="margin-left:25px; margin-right:25px; display: block;">
			...
			<div class="panel-body panel-subMenu">
				<div class="row row-subMenu">
					<div class="col-md-3">
						<label class="radio-inline"><b> <input type="RADIO" name="action" id="A" value="A" tabindex="5">Create Account</b>
						</label>
					</div>
					
					<div class="col-md-3">
						<label class="radio-inline"><b> <input type="RADIO" name="action" id="C" value="C" tabindex="7">Modify Account</b>
						</label>
					</div>
					
					<div class="col-md-3">
						<label class="radio-inline"><b> <input type="RADIO" name="action" id="E" value="E" tabindex="8">Enquire on Account</b>
						</label>
					</div>
				</div>
			</div>
