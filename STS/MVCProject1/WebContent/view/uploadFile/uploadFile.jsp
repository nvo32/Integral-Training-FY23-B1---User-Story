...
<body>
	...
	<form>
		<div id="mainareaDiv" style="width: 100%; height: auto;">
			<!-- IGROUP-6065 -->
			<div id="headerTopLink"
				style="top: 2px; left: 1px; right: 1px; z-index: 5;" class="header">
				<input type="hidden" name="sflheaderList" id="sflheaderList">
				<input type="hidden" name="sflVarList" id="sflVarList"> <input
					type="text" id="dtformat" value="dd/MM/yyyy"
					style="visibility: hidden;" class="form-control"> <input
					type="text" id="global_path" value="/csc-group-asia-web/"
					style="visibility: hidden;" class="form-control"> <input
					type="text" id="lang" value="eng" style="visibility: hidden;"
					class="form-control"> <input type="hidden"
					id="xssblacklist" value="" style="visibility: hidden;"> <input
					type="text" id="input_value" value="Input"
					style="visibility: hidden;" class="form-control"> <input
					type="text" id="action_value" value="Action"
					style="visibility: hidden;" class="form-control"> <input
					type="hidden" id="istk" name="istk" value=""
				...
				<div class="container" style="margin-top: -140px; display: block;">
					...
					<div id="page-header" class="row">
						<h1
							style="margin: 25px 15px 15px 15px !important; font-family: 'Oswald', sans-serif !important; font-weight: 500 !important; font-size: 24px !important; border-bottom: 1px solid #eee !important; border-bottom-style: double !important; margin-bottom: 10px""="">File
							Upload</h1>
					...
					<div id="msg-panel" class="panel panel-info mainform-msg"
					...
					<div class="panel panel-default" style="height: auto;">
						<div class="panel-heading">
							<img
								src="/csc-group-asia-web/screenFiles/eng/menu/Input_icon02.png"
								height="25" title="Input">Input
						</div>
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-3">
									...
									<label>File Type</label> <select name="uploadFileType"
										class="form-control" tabindex="2">
										<option value="">Select File Type</option>

										<option value="MBRUPLOD">Member Upload</option>

										<option value="RCTUPLOD">Receipt Upload</option>

										<option value="ADDMASTER">Client Upload</option>
							...
							<div class="row">
								<div id="req-file" style="display: none">
									<div class="col-md-4">
										<label>Batch Job Request File</label> <input type="file"
											name="requestfile" class="form-control">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<button style="padding-right: 70px" class="btn btn-info"
										name="submitForm" type="button" value="Upload File"
										onclick="uploadFileForm()" tabindex="4">Upload File</button>
								</div>
							</div>
						...
						<table>
							<tbody>
								<tr style="height: 22px;">
									<td width="371">&nbsp; &nbsp;<br></td>
									<td width="371">&nbsp; &nbsp;<br> <input
										name="action" type="hidden" value=" " size="1"
										onhelp="return fieldHelp(action)" maxlength="1"
										class="input_cell" onfocus="doFocus(this)"
										onkeyup="return checkMaxLength(this)"></td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<input type="hidden" name="action_key" value="PFKEY03">
					<!-- IGROUP-3626 -->

					<input type="hidden" name="screen" value="Sr2de"> <input
						type="hidden" name="focusField" value=""> <input
						type="hidden" name="focusInField" value=""> <input
						type="hidden" name="focusPrevF" value="busddates"> <input
					...
					<div id="navigateButton" class="text-right"
						...
						<button id="exitbutton" style="margin-right: 2px !important;"
							...
							onclick="doAction('PFKEY03');" tabindex="5">Exit</button>
						<button id="continuebutton" style="margin-right: 2px !important;"
							type="button" class="btn btn-success btn-sm"
							onclick="doAction('PFKEY0');" tabindex="6">Continue</button>
					</div>
				</div>
	</form>
</body>
