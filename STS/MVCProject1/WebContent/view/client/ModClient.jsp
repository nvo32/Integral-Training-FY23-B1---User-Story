		...
		<div class="panel panel-default" style="height: auto;">
			<div class="panel-body">
										...
										<td>
											<div class="input-group date form_date col-md-12">
												<input name="birthday" type="text" size="10"
													...
													maxlength="10" class="input_cell bold form-control" placeholder="<%=birthday %>">
						...
						<div class="form-group">
							...
							<div style="width: 150px;">
								<input name="idNum" type="text" size="16"
									...
									maxlength="16" placeholder="<%=idNum %>">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							<label>
								...
								style="overflow: hidden; white-space: nowrap; position: relative; top: 0; left: 0; text-align: left;"
								maxlength="30" class="form-control" placeholder="<%=firstname %>">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
							...
							<div style="position: relative;">
								<select name="martialStatus" id="martialStatus" type="list"
									style="width: 200.0px;" class="form-control">
									<option value="" title="---------Select---------"><%=marritalStatus%></option>
						...
						<div class="form-group">
							...
							<div style="position: relative;">
								<select name="gender" id="gender" type="list"
									style="width: 200.0px;" class="form-control">
									<option value="" title="---------Select---------"><%=gender%></option>
									<c:forEach items="${listGender}" var="listGender">
										<option value="${listGender.id}" id="${listGender.id}">${listGender.gender}</option>
									</c:forEach>
								</select>
							</div>
						</div>
					...
					<div class="col-md-3">
						<div class="form-group">
							<label><div class="label_txt"
								...
								style="overflow: hidden; white-space: nowrap; position: relative; top: 0; left: 0; text-align: left;"
								maxlength="30" class="form-control" placeholder="<%=lastname %>">
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group">
									...
									<tbody>
										<tr>
											<td><input name="address" id="address" type="text"
												...
												maxlength="50" class="form-control" placeholder="<%=address %>"></td>
										</tr>
									</tbody>
								</table>
							</div>
				...
				<div style="margin-left: 900px">
					...
					<button style="margin-right: 2px !important;" type="submit"
